        ...
        try {
            ...
            return {
                ...
                student: {
                    ...
                    tempatLahir: row.student.tempatLahir,
                    tanggalLahir: row.student.tanggalLahir,
                    agama: row.student.agama,
                    alamatSiswa: row.student.alamatSiswa,
                    nmAyah: row.student.nmAyah,
                    nmIbu: row.student.nmIbu,
                    pekerjaanAyah: row.student.pekerjaanAyah,
                    pekerjaanIbu: row.student.pekerjaanIbu,
                    alamatOrtu: row.student.alamatOrtu,
                    statusDalamKel: row.student.statusDalamKel,
                    anakKe: row.student.anakKe,
