...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[400px] p-0">
                ...
                <div className="flex flex-col py-6 px-4 gap-2">
                  <a href="#beranda" onClick={() => setIsOpen(false)} className="px-4 py-3 rounded-md hover:bg-slate-50 text-slate-600 font-medium transition-colors">Beranda</a>
                  <a href="#alur" onClick={() => setIsOpen(false)} className="px-4 py-3 rounded-md hover:bg-slate-50 text-slate-600 font-medium transition-colors">Alur</a>
                  <a href="#persyaratan" onClick={() => setIsOpen(false)} className="px-4 py-3 rounded-md hover:bg-slate-50 text-slate-600 font-medium transition-colors">Persyaratan</a>
                  <a href="#jadwal" onClick={() => setIsOpen(false)} className="px-4 py-3 rounded-md hover:bg-slate-50 text-slate-600 font-medium transition-colors">Jadwal</a>
                  <a href="#galeri" onClick={() => setIsOpen(false)} className="px-4 py-3 rounded-md hover:bg-slate-50 text-slate-600 font-medium transition-colors">Galeri</a>
                  <a href="#kontak" onClick={() => setIsOpen(false)} className="px-4 py-3 rounded-md hover:bg-slate-50 text-slate-600 font-medium transition-colors">Kontak</a>
                </div>
      ...
      <section id="beranda" className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative z-10 rounded-md overflow-hidden shadow-2xl border-4 border-white transform lg:rotate-2 hover:rotate-0 transition-transform duration-500">
              <img
                src="/hero.webp"
          ...
          <Tabs defaultValue="tahap1" className="w-full">
            ...
            <TabsContent value="tahap1">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-8 items-start">
                ...
                <div className="lg:col-span-8 bg-white rounded-md p-4 sm:p-6 md:p-10 border border-slate-100 shadow-sm relative">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
            {randomGallery.map((item, index) => (
              <div
                key={index}
                className="group relative overflow-hidden rounded-md aspect-square bg-slate-200 cursor-zoom-in"
              ...
              {selectedImage && (
                <div className="relative w-full h-full flex items-center justify-center animate-in fade-in zoom-in duration-300">
                  <img
                    ...
                    alt="Galeri Full"
                    className="max-w-full max-h-[90vh] object-contain rounded-md shadow-2xl border-4 border-white/10"
                  />
                </div>
              )}
            </DialogContent>
      ...
      <a 
        href="https://chat.whatsapp.com/GANTI_DENGAN_LINK_GRUP_ANDA" 
        target="_blank" 
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-[60] group flex items-center gap-3"
      >
        {/* Tooltip Label */}
        <span className="bg-white text-slate-900 px-4 py-2 rounded-md shadow-xl text-sm font-bold opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0 transition-all duration-300 pointer-events-none border border-slate-100">
          Gabung Grup Info
        </span>
        
        {/* Button Wrapper with Pulse Effect */}
        <div className="relative">
          <div className="absolute inset-0 bg-green-500 rounded-full animate-ping opacity-25"></div>
          <div className="relative bg-[#25D366] hover:bg-[#20ba5a] text-white p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center">
            <svg 
              viewBox="0 0 448 512" 
