...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      ...
      >
        {/* Tooltip Label */}
        <span className="bg-white text-slate-900 px-4 py-2 rounded-full shadow-xl text-sm font-bold opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0 transition-all duration-300 pointer-events-none border border-slate-100">
          Gabung Grup Info
        </span>
