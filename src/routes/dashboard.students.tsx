                        ...
                        <div className="flex items-center gap-2 flex-1 md:justify-end max-w-sm">
                            <div className="relative w-full">
                                ...
                                <Input
                                    ...
                                    className="pl-9 bg-white h-8 border-slate-300 rounded-md"
                                    value={searchTerm}
                                    onChange={(e) => {
                ...
                <TabsContent value="identity" forceMount className="space-y-3 mt-3 data-[state=inactive]:hidden">
                    <div className="grid grid-cols-5 gap-3">
                        ...
                        <div className="space-y-1 col-span-2">
                            ...
                            <Input id="edit-nmSiswa" name="nmSiswa" defaultValue={student?.nmSiswa} required className="h-8 border-slate-300 rounded-md" />
                        </div>
                        <div className="space-y-1">
                        ...
                        <div className="space-y-1 relative">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    className="h-8 bg-white pr-8 border-slate-300 rounded-md"
                                    autoComplete="off"
                                />
                                {isSearchingSekolah && (
